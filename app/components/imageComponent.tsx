...
import { ImageSvg } from "./svgContainer";
...
export function ImageComponent({
    ...
    console.log("value from image", value)
    const { content } = value;
    ...
    return (
        ...
        >
              {content.src === '' ? 
                ...
                <ImageSvg /> 
             </div>:  <div className=" tw-flex tw-justify-center tw-items-center tw-h-full tw-w-full">
                <img src={content.src} alt="image" className=" tw-w-full tw-object-cover tw-bg-no-repeat " /> 
             </div>}
             <div
